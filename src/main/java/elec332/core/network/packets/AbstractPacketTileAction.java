...
public abstract class AbstractPacketTileAction extends AbstractPacket {
    ...
    public AbstractPacketTileAction(TileEntity tile, CompoundTag message) {
        this(tile, message, 0);
    }

    public AbstractPacketTileAction(TileEntity tile, CompoundTag message, int id) {
    ...
    public abstract void processPacket(World world, TileEntity tile, int id, CompoundTag message, IExtendedMessageContext ctx);
